...
struct NSPShardPlannerPass
  ...
  void runOnOperation() override {
    ...
    for (linalg::GenericOp op : generics) {
      ...
      // Collective materialization is not currently implemented in the NSPSharding
      // pipeline. Keep requiresAllReduce as analysis information in the plan,
      // but fail explicitly instead of silently pretending support exists.
      //
