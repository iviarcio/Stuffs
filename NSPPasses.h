...
/// Create the planner pass with explicit policy parameters.
/// \param nspCount  Number of participants in the 1-D shard grid.
...
/// Invoked as: --pass-pipeline="nsp-shard(nsp-count=32 propagation=true ...)"
void registerNSPPipelines();

/// Register NSP-related dialect extensions (shard, tensor, bufferization, etc.)
/// into the given DialectRegistry. Must be called before context creartion so
...
/// propagation, but are not part of the shard dialect (e.g., linzlg.geneic,
