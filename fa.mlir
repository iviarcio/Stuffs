...
module attributes {llvm.target_triple = "hexagon"} {
  ...
  func.func @attention_fwd_kernel(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: memref<*xf32> {tt.divisibility = 16 : i32}, %arg2: memref<*xf32> {tt.divisibility = 16 : i32}, %arg3: memref<*xf32> {tt.divisibility = 16 : i32}, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32) {
    ...
    %7:5 = scf.for %arg10 = %c0_i32 to %c1024_i32 step %c16_i32 iter_args(%arg11 = %5, %arg12 = %2, %arg13 = %3, %arg14 = %c0_i64, %arg15 = %c0_i64) -> (tensor<32x64xf32>, tensor<32xf32>, tensor<32xf32>, i64, i64) {
      ...
      %reduced = linalg.reduce ins(%15 : tensor<32x16xf32>) outs(%16 : tensor<32xf32>) dimensions = [1]
        (%in: f32, %init: f32) {
