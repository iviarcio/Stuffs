...
//
// This file is based on MLIR's ShardingPropagation.cpp, with an NSP-specific
// boundary rule for bufferization.materialize_in_destination.
//
// This pass preserves the upstream propagation behavior for tensor operations
// but treats bufferization.materialize_in_destination as an NSP boundary. This
// avoids propagating sharding through a tensor-to-buffer sink whose destination
// is a memref, which is rejected by LLVM/MLIR ShardingInterface verification.
//===----------------------------------------------------------------------===//
