...
struct LowerAllSlice final : public RewritePattern {
  ...
  LogicalResult matchAndRewrite(Operation *op,
    ...
    Value sliceSize0 =
        arith::ConstantIndexOp::create(rewriter, loc, sliceShape[0]);
    Value offset0 = arith::MulIOp::create(rewriter, loc, linearIdx, sliceSize0);
    ...
    sizes.push_back(rewriter.getIndexAttr(sliceShape[0]));
